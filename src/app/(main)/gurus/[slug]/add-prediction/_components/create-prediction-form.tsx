...
export function CreatePredictionForm({
  ...
  return (
    <Form action={action} aria-busy={isPending}>
      <FormHeader
        title={`Log a Prediction for ${guruName}`}
        description="Add a new claim to the database to begin tracking it."
      />
      <FormContent>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <FormGroup>
            <Label htmlFor="confidence_level">Guru&apos;s Confidence (%)</Label>
            <Input
              id="confidence_level"
